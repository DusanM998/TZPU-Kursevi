...
using TZPU.Services.ShoppingCardAPI.Extensions;
...
using TZPU.Services.ShoppingCardAPI.Utility;
...
builder.Services.AddHttpClient("Coupon", u => u.BaseAddress =
 new Uri(builder.Configuration["ServiceUrls:CouponAPI"])).AddHttpMessageHandler<BackendApiAuthenticaionHttpClientHandler>();
